...
merge_package master https://github.com/kiddin9/openwrt-packages package/more ddns-go luci-app-ddns-go autocore luci-app-fileassistant \
luci-app-accesscontrol luci-app-autoreboot luci-app-filetransfer luci-app-vlmcsd vlmcsd luci-lib-fs
